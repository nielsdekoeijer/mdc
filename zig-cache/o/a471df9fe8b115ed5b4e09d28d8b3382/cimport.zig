...
pub const struct__typeobject = extern struct {
    ...
    tp_methods: [*c]PyMethodDef,
    tp_members: ?*PyMemberDef,
    tp_getset: [*c]PyGetSetDef,
    tp_base: [*c]PyTypeObject,
    tp_dict: [*c]PyObject,
...
pub const struct_PyCodeObject = extern struct {
    ...
    co_names: [*c]PyObject,
    co_exceptiontable: [*c]PyObject,
    co_flags: c_int,
    co_warmup: c_short,
    _co_linearray_entry_size: c_short,
    co_argcount: c_int,
    ...
    co_nlocals: c_int,
    co_nplaincellvars: c_int,
    co_ncellvars: c_int,
    co_nfreevars: c_int,
    co_localsplusnames: [*c]PyObject,
    co_localspluskinds: [*c]PyObject,
    co_filename: [*c]PyObject,
    co_name: [*c]PyObject,
    co_qualname: [*c]PyObject,
...
pub const struct__PyCFrame = extern struct {
    use_tracing: u8,
    current_frame: ?*struct__PyInterpreterFrame,
    previous: [*c]struct__PyCFrame,
};
...
pub const struct__stack_chunk = extern struct {
    previous: [*c]struct__stack_chunk,
    size: usize,
    top: usize,
    data: [1][*c]PyObject,
};
...
pub const struct__ts = extern struct {
    prev: [*c]PyThreadState,
    next: [*c]PyThreadState,
    interp: ?*PyInterpreterState,
    _initialized: c_int,
    _static: c_int,
    recursion_remaining: c_int,
    recursion_limit: c_int,
    ...
    datastack_chunk: [*c]_PyStackChunk,
    datastack_top: [*c][*c]PyObject,
    datastack_limit: [*c][*c]PyObject,
...
pub const struct__heaptypeobject = extern struct {
    ...
    _ht_tpname: [*c]u8,
    _spec_cache: struct__specialization_cache,
};
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(op, &PyByteArray_Type) != 0) {} else {
                    __assert_fail("PyByteArray_Check(op)", "/usr/include/python3.11/cpython/bytearrayobject.h", @as(c_uint, @bitCast(@as(c_int, 22))), "char *PyByteArray_AS_STRING(PyObject *)");
                };
            };
        };
...
pub fn PyByteArray_GET_SIZE(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    var self: [*c]PyByteArrayObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(op, &PyByteArray_Type) != 0) {} else {
                    __assert_fail("PyByteArray_Check(op)", "/usr/include/python3.11/cpython/bytearrayobject.h", @as(c_uint, @bitCast(@as(c_int, 33))), "Py_ssize_t PyByteArray_GET_SIZE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyByteArrayObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(27)) != 0) {} else {
                    __assert_fail("PyBytes_Check(op)", "/usr/include/python3.11/cpython/bytesobject.h", @as(c_uint, @bitCast(@as(c_int, 37))), "char *PyBytes_AS_STRING(PyObject *)");
                };
            };
        };
...
pub fn PyBytes_GET_SIZE(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    var self: [*c]PyBytesObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(27)) != 0) {} else {
                    __assert_fail("PyBytes_Check(op)", "/usr/include/python3.11/cpython/bytesobject.h", @as(c_uint, @bitCast(@as(c_int, 44))), "Py_ssize_t PyBytes_GET_SIZE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyBytesObject, @ptrCast(@alignCast(op)));
...
pub const Py_UNICODE = wchar_t; // /usr/include/python3.11/cpython/unicodeobject.h:158:22: warning: struct demoted to opaque type - has bitfield
const struct_unnamed_13 = opaque {};
pub const PyASCIIObject = extern struct {
    ob_base: PyObject,
    length: Py_ssize_t,
    hash: Py_hash_t,
    state: struct_unnamed_13,
    wstr: [*c]wchar_t,
};
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 260))), "unsigned int PyUnicode_CHECK_INTERNED(PyObject *)");
                };
            };
        };
...
pub fn PyUnicode_IS_READY(arg_op: [*c]PyObject) callconv(.C) c_uint {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 269))), "unsigned int PyUnicode_IS_READY(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_IS_ASCII(arg_op: [*c]PyObject) callconv(.C) c_uint {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (PyUnicode_IS_READY(op) != 0) {} else {
                __assert_fail("PyUnicode_IS_READY(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 279))), "unsigned int PyUnicode_IS_ASCII(PyObject *)");
            };
        };
    };
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 280))), "unsigned int PyUnicode_IS_ASCII(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_IS_COMPACT(arg_op: [*c]PyObject) callconv(.C) c_uint {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 289))), "unsigned int PyUnicode_IS_COMPACT(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_IS_COMPACT_ASCII(arg_op: [*c]PyObject) callconv(.C) c_int {
    ...
    return @intFromBool((@as(c_int, @bitCast((blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 298))), "int PyUnicode_IS_COMPACT_ASCII(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn _PyUnicode_COMPACT_DATA(arg_op: [*c]PyObject) callconv(.C) ?*anyopaque {
    ...
    if (PyUnicode_IS_ASCII(op) != 0) {
        return @as(?*anyopaque, @ptrCast((blk: {
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 323))), "void *_PyUnicode_COMPACT_DATA(PyObject *)");
                    };
                };
            };
            break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
    ...
    return @as(?*anyopaque, @ptrCast((blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 325))), "void *_PyUnicode_COMPACT_DATA(PyObject *)");
                };
            };
        };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (!(PyUnicode_IS_COMPACT(op) != 0)) {} else {
                __assert_fail("!PyUnicode_IS_COMPACT(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 330))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
            };
        };
    };
    data = (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 331))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
                };
            };
        };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (data != @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {} else {
                __assert_fail("data != NULL", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 332))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
            };
        };
    };
    return data;
...
pub fn PyUnicode_GET_LENGTH(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (PyUnicode_IS_READY(op) != 0) {} else {
                __assert_fail("PyUnicode_IS_READY(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 359))), "Py_ssize_t PyUnicode_GET_LENGTH(PyObject *)");
            };
        };
    };
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 360))), "Py_ssize_t PyUnicode_GET_LENGTH(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 255)) {} else {
                    __assert_fail("value <= 0xffU", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 375))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 65535)) {} else {
                    __assert_fail("value <= 0xffffU", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 379))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                    __assert_fail("kind == PyUnicode_4BYTE_KIND", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 383))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 1114111)) {} else {
                    __assert_fail("value <= 0x10ffffU", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 384))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
...
pub fn PyUnicode_READ(arg_kind: c_int, arg_data: ?*const anyopaque, arg_index_1: Py_ssize_t) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 405))), "Py_UCS4 PyUnicode_READ(int, const void *, Py_ssize_t)");
            };
        };
    };
    return (blk: {
...
pub fn PyUnicode_READ_CHAR(arg_unicode: [*c]PyObject, arg_index_1: Py_ssize_t) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (PyUnicode_IS_READY(unicode) != 0) {} else {
                __assert_fail("PyUnicode_IS_READY(unicode)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 422))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
            };
        };
    };
    kind = @as(c_int, @bitCast(blk: {
        _ = blk_1: {
            _ = @sizeOf(c_int);
            break :blk_1 blk_2: {
                break :blk_2 if (PyUnicode_IS_READY(unicode) != 0) {} else {
                    __assert_fail("PyUnicode_IS_READY(unicode)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 423))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
                };
            };
        };
        break :blk (blk_1: {
            _ = blk_2: {
                ...
                break :blk_2 blk_3: {
                    break :blk_3 if (PyType_HasFeature(Py_TYPE(unicode), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(unicode)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 423))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
                    };
                };
            };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 430))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
            };
        };
    };
    return (blk: {
...
pub fn PyUnicode_MAX_CHAR_VALUE(arg_op: [*c]PyObject) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (PyUnicode_IS_READY(op) != 0) {} else {
                __assert_fail("PyUnicode_IS_READY(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 445))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
            };
        };
    };
    if (PyUnicode_IS_ASCII(op) != 0) {
    ...
    kind = @as(c_int, @bitCast(blk: {
        _ = blk_1: {
            _ = @sizeOf(c_int);
            break :blk_1 blk_2: {
                break :blk_2 if (PyUnicode_IS_READY(op) != 0) {} else {
                    __assert_fail("PyUnicode_IS_READY(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 450))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
                };
            };
        };
        break :blk (blk_1: {
            _ = blk_2: {
                ...
                break :blk_2 blk_3: {
                    break :blk_3 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 450))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
                    };
                };
            };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 457))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
            };
        };
    };
    return 1114111;
    ...
    if (PyUnicode_IS_COMPACT_ASCII(op) != 0) {
        return (blk: {
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 636))), "Py_ssize_t PyUnicode_WSTR_LENGTH(PyObject *)");
                    };
                };
            };
            break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
        ...
        return (blk: {
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 639))), "Py_ssize_t PyUnicode_WSTR_LENGTH(PyObject *)");
                    };
                };
            };
            break :blk @as(?*PyCompactUnicodeObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_GET_SIZE(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    if ((blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 656))), "Py_ssize_t PyUnicode_GET_SIZE(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
            ...
            break :blk blk_1: {
                break :blk_1 if ((blk_2: {
                    _ = blk_3: {
                        _ = @sizeOf(c_int);
                        break :blk_3 blk_4: {
                            break :blk_4 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                                __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 658))), "Py_ssize_t PyUnicode_GET_SIZE(PyObject *)");
                            };
                        };
                    };
                    break :blk_2 @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
                }).*.wstr != @as([*c]wchar_t, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                    __assert_fail("_PyASCIIObject_CAST(op)->wstr != _Py_NULL", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 658))), "Py_ssize_t PyUnicode_GET_SIZE(PyObject *)");
                };
            };
        };
    }
...
pub fn PyUnicode_AS_UNICODE(arg_op: [*c]PyObject) callconv(.C) [*c]Py_UNICODE {
    ...
    var wstr: [*c]wchar_t = (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/usr/include/python3.11/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 687))), "Py_UNICODE *PyUnicode_AS_UNICODE(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(26)) != 0) {} else {
                    __assert_fail("PyTuple_Check(op)", "/usr/include/python3.11/cpython/tupleobject.h", @as(c_uint, @bitCast(@as(c_int, 23))), "Py_ssize_t PyTuple_GET_SIZE(PyObject *)");
                };
            };
        };
...
pub fn PyTuple_SET_ITEM(arg_op: [*c]PyObject, arg_index_1: Py_ssize_t, arg_value: [*c]PyObject) callconv(.C) void {
    ...
    var tuple: [*c]PyTupleObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(26)) != 0) {} else {
                    __assert_fail("PyTuple_Check(op)", "/usr/include/python3.11/cpython/tupleobject.h", @as(c_uint, @bitCast(@as(c_int, 35))), "void PyTuple_SET_ITEM(PyObject *, Py_ssize_t, PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyTupleObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(25)) != 0) {} else {
                    __assert_fail("PyList_Check(op)", "/usr/include/python3.11/cpython/listobject.h", @as(c_uint, @bitCast(@as(c_int, 34))), "Py_ssize_t PyList_GET_SIZE(PyObject *)");
                };
            };
        };
...
pub fn PyList_SET_ITEM(arg_op: [*c]PyObject, arg_index_1: Py_ssize_t, arg_value: [*c]PyObject) callconv(.C) void {
    ...
    var list: [*c]PyListObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(25)) != 0) {} else {
                    __assert_fail("PyList_Check(op)", "/usr/include/python3.11/cpython/listobject.h", @as(c_uint, @bitCast(@as(c_int, 45))), "void PyList_SET_ITEM(PyObject *, Py_ssize_t, PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyListObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func)", "/usr/include/python3.11/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 41))), "PyCFunction PyCFunction_GET_FUNCTION(PyObject *)");
                };
            };
        };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func_obj, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func_obj)", "/usr/include/python3.11/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 48))), "PyObject *PyCFunction_GET_SELF(PyObject *)");
                };
            };
        };
...
pub fn PyCFunction_GET_FLAGS(arg_func: [*c]PyObject) callconv(.C) c_int {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func)", "/usr/include/python3.11/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 59))), "int PyCFunction_GET_FLAGS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyCFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyCFunction_GET_CLASS(arg_func_obj: [*c]PyObject) callconv(.C) [*c]PyTypeObject {
    ...
    var func: [*c]PyCFunctionObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func_obj, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func_obj)", "/usr/include/python3.11/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 66))), "PyTypeObject *PyCFunction_GET_CLASS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyCFunctionObject, @ptrCast(@alignCast(func_obj)));
            ...
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyObject_TypeCheck(@as([*c]PyObject, @ptrCast(@alignCast(func))), &PyCMethod_Type) != 0) {} else {
                        __assert_fail("PyCMethod_Check(func)", "/usr/include/python3.11/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 68))), "PyTypeObject *PyCFunction_GET_CLASS(PyObject *)");
                    };
                };
            };
...
pub const _PyFrameEvalFunction = ?*const fn ([*c]PyThreadState, ?*struct__PyInterpreterFrame, c_int) callconv(.C) [*c]PyObject;
...
pub const struct__xid = extern struct {
    ...
    obj: [*c]PyObject,
    interp: i64,
    new_object: ?*const fn ([*c]_PyCrossInterpreterData) callconv(.C) [*c]PyObject,
...
pub const PyGenObject = extern struct {
    ob_base: PyObject,
    gi_code: [*c]PyCodeObject,
    gi_weakreflist: [*c]PyObject,
    gi_name: [*c]PyObject,
    gi_qualname: [*c]PyObject,
    gi_exc_state: _PyErr_StackItem,
    gi_origin_or_finalizer: [*c]PyObject,
    gi_hooks_inited: u8,
    gi_closed: u8,
    gi_running_async: u8,
    gi_frame_state: i8,
    gi_iframe: [1][*c]PyObject,
};
...
pub const PyCoroObject = extern struct {
    ob_base: PyObject,
    cr_code: [*c]PyCodeObject,
    cr_weakreflist: [*c]PyObject,
    cr_name: [*c]PyObject,
    cr_qualname: [*c]PyObject,
    cr_exc_state: _PyErr_StackItem,
    cr_origin_or_finalizer: [*c]PyObject,
    cr_hooks_inited: u8,
    cr_closed: u8,
    cr_running_async: u8,
    cr_frame_state: i8,
    cr_iframe: [1][*c]PyObject,
};
...
pub const PyAsyncGenObject = extern struct {
    ob_base: PyObject,
    ag_code: [*c]PyCodeObject,
    ag_weakreflist: [*c]PyObject,
    ag_name: [*c]PyObject,
    ag_qualname: [*c]PyObject,
    ag_exc_state: _PyErr_StackItem,
    ag_origin_or_finalizer: [*c]PyObject,
    ag_hooks_inited: u8,
    ag_closed: u8,
    ag_running_async: u8,
    ag_frame_state: i8,
    ag_iframe: [1][*c]PyObject,
};
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if ((PyObject_TypeCheck(ref_obj, &_PyWeakref_RefType) != 0) or ((Py_IS_TYPE(ref_obj, &_PyWeakref_ProxyType) != 0) or (Py_IS_TYPE(ref_obj, &_PyWeakref_CallableProxyType) != 0))) {} else {
                __assert_fail("PyWeakref_Check(ref_obj)", "/usr/include/python3.11/cpython/weakrefobject.h", @as(c_uint, @bitCast(@as(c_int, 42))), "PyObject *PyWeakref_GET_OBJECT(PyObject *)");
            };
        };
    };
...
pub extern fn _PyEval_EvalFrameDefault(tstate: [*c]PyThreadState, f: ?*struct__PyInterpreterFrame, exc: c_int) [*c]PyObject;
...
pub const struct__frozen = extern struct {
    ...
    size: c_int,
    is_package: c_int,
    get_code: ?*const fn () callconv(.C) [*c]PyObject,
};
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @as([*c]PyObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("arg != NULL", "/usr/include/python3.11/cpython/abstract.h", @as(c_uint, @bitCast(@as(c_int, 115))), "PyObject *PyObject_CallMethodOneArg(PyObject *, PyObject *, PyObject *)");
            };
        };
    };
...
pub fn _PyObject_CallMethodIdOneArg(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @as([*c]PyObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("arg != NULL", "/usr/include/python3.11/cpython/abstract.h", @as(c_uint, @bitCast(@as(c_int, 163))), "PyObject *_PyObject_CallMethodIdOneArg(PyObject *, _Py_Identifier *, PyObject *)");
            };
        };
    };
...
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.11/cpython/object.h:48:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/python3.11/cpython/object.h:49:9
pub const _Py_IDENTIFIER = @compileError("unable to translate macro: undefined identifier `PyId_`"); // /usr/include/python3.11/cpython/object.h:50:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.11/cpython/object.h:331:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`"); // /usr/include/python3.11/cpython/object.h:338:9
pub const _PyObject_ASSERT_WITH_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.11/cpython/object.h:387:9
pub const _PyObject_ASSERT_FAILED_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/python3.11/cpython/object.h:392:9
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.11/cpython/object.h:477:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /usr/include/python3.11/cpython/object.h:489:9
pub const Py_TRASHCAN_SAFE_BEGIN = @compileError("unable to translate macro: undefined identifier `cond`"); // /usr/include/python3.11/cpython/object.h:505:9
pub const Py_TRASHCAN_SAFE_END = @compileError("unable to translate C expr: unexpected token ';'"); // /usr/include/python3.11/cpython/object.h:509:9
...
pub const _PyByteArray_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/bytearrayobject.h:17:9
...
pub const _PyBytes_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/bytesobject.h:32:9
...
pub const _PyASCIIObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:238:9
pub const _PyCompactUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:241:9
pub const _PyUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:244:9
pub const PyUnicode_1BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:351:9
pub const PyUnicode_2BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:352:9
pub const PyUnicode_4BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/unicodeobject.h:353:9
...
pub const _PyTuple_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/tupleobject.h:17:9
pub const _PyList_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/listobject.h:28:9
...
pub const _PyCFunctionObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/methodobject.h:16:9
pub const _PyCMethodObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /usr/include/python3.11/cpython/methodobject.h:28:9
...
pub const COMMON_FIELDS = @compileError("unable to translate macro: undefined identifier `globals`"); // /usr/include/python3.11/cpython/funcobject.h:11:9
pub const _Py_SET_OPCODE = @compileError("unable to translate C expr: expected ')' instead got '='"); // /usr/include/python3.11/cpython/code.h:32:9
pub const _PyCode_DEF = @compileError("unable to translate macro: undefined identifier `co_consts`"); // /usr/include/python3.11/cpython/code.h:36:9
pub const PyCell_SET = @compileError("unable to translate C expr: expected ',' or ')' instead got '='"); // /usr/include/python3.11/cpython/cellobject.h:25:9
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_code`"); // /usr/include/python3.11/cpython/genobject.h:14:9
pub const PyDescr_COMMON = @compileError("unable to translate macro: undefined identifier `d_common`"); // /usr/include/python3.11/cpython/descrobject.h:33:9
pub const PyException_HEAD = @compileError("unable to translate macro: undefined identifier `dict`"); // /usr/include/python3.11/cpython/pyerrors.h:8:9
...
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/python3.11/cpython/pythread.h:42:9
...
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.11/cpython/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/python3.11/cpython/pyfpe.h:12:9
