...
pub const filteredDownsample = @import("filteredDownsample.zig").filteredDownsample;

pub fn filteredDownsample_pybind(_: [*c]python.PyObject, args: [*c]python.PyObject) callconv(.C) ?*python.PyObject {
    // parse inputs
    ...
    filteredDownsample(iBuffer, mBuffer, oBuffer, coefficients, state, factor);
