...
pub const filteredUpsample = @import("filteredUpsample.zig").filteredUpsample;

pub fn filteredUpsample_pybind(_: [*c]python.PyObject, args: [*c]python.PyObject) callconv(.C) ?*python.PyObject {
    // parse inputs
    ...
    filteredUpsample(iBuffer, mBuffer, oBuffer, coefficients, state, factor);
